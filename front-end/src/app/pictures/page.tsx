                    ...
                    <ul className={styles.ulCard}>
                        {
                            fakePictures.map((picture, index) => (
                                <li key={index} className={`${styles.card} art-border-solid-white-03:0.5:full art-bg-white-03:hover`}>
                                    <a className={styles.link} href="../../../image/1733577396352.png" download={picture.imgName} >
